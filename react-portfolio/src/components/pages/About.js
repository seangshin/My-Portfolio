...
function About() {
  return (
    <div>
      <h3>About Me</h3>
      <img className="img-fluid rounded-circle mt-5" width="200" height="200" src="./assets/profile.JPG" alt="Profile Picture" />
      <div className="lead font-weight-bold subheading mt-5 mb-5">
          Software Engineer · Detroit, MI · (248) 890-0266 ·
